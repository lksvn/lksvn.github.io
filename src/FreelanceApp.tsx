        ...
        <>
            <header>
                <nav aria-label="Navegação principal">
                    <ul>
                        <li><Icon name="squirrel" /> <a href="#inicio">Lucas Vinicius</a></li>
            ...
            <main>
                <section id="inicio">
                    <p className="eyebrow">Design gráfico e sites</p>
                    ...
                    <a href="https://wa.me/5511953988891?text=Ol%C3%A1%2C%20Lucas%21%20Gostaria%20de%20conversar%20sobre%20um%20servi%C3%A7o." target="_blank" rel="noopener noreferrer" className="whatsapp-button"><Icon name="whatsapp"/> Vamos conversar</a>
                </section>
                <section id="servicos">
                ...
                <section id="trabalhos">
                    ...
                    <div className="cta-wrapper">
                        <a href="https://wa.me/5511953988891?text=Ol%C3%A1%2C%20Lucas%21%20Vi%20seus%20trabalhos%20e%20gostaria%20de%20conversar%20sobre%20algo%20parecido." target="_blank" rel="noopener noreferrer" className="whatsapp-button cta"><Icon name="whatsapp"/> Vamos conversar</a>
                    </div>
                </section>
                <div className="grid">
                ...
                <section id="contato" className="cta-card">
                    <h2>Como começar?</h2>
                    <p>Conte pelo WhatsApp o que você precisa. Não precisa ter tudo definido.</p>
                    <div>
                        <a href="https://wa.me/5511953988891?text=Ol%C3%A1%2C%20Lucas%21%20Vi%20seu%20site%20e%20gostaria%20de%20solicitar%20um%20or%C3%A7amento." target="_blank" rel="noopener noreferrer" className="whatsapp-button"><Icon name="whatsapp"/> Vamos conversar</a>
                    </div>
                </section>
                <footer>
                    <p><Icon name="squirrel"/> <strong>Lucas Vinicius</strong></p>
                    ...
                    <nav aria-label="Links de contato">
                        <ul>
                            ...
                            <li><a href="mailto:lksvn@outlook.com"><Icon name="email"/> E-mail</a></li>
                            <li><a href="/"><Icon name="book-open"/> Portfólio</a></li>
                        </ul>
                    </nav>
                    <p>Sorocaba, SP &bull; Atendimento remoto</p>
                    <p>&copy; 2026 Lucas Vinicius. Todos os direitos reservados.</p>
                </footer>
